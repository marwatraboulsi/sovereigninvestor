  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.header}>
        ...
        <Text style={s.headerTitle}>Saved Research</Text>
      </View>
...
const s = StyleSheet.create({
  ...
  backBtn:     { padding: 4 },
  headerTitle: { fontSize: 20, fontWeight: '700', color: W, letterSpacing: -0.3, fontFamily: SERIF },
  ...
  cardBody:  { flexDirection: 'row', padding: 16, gap: 12 },
